...
describe('polygon', () => {
    ...
    describe('type', () => {
        test('it should be a function', () => {
            expect(Polygon.toString()).toContain('function Polygon');
        });
    });
...
describe('square polygon', () => {
    ...
    describe('type', () => {
        test('it should be a function', () => {
            expect(Square.toString()).toContain('function Square');
        });
    });
...
describe('triangle polygon', () => {
    ...
    describe('type', () => {
        test('it should be a function', () => {
            expect(Triangle.toString()).toContain('function Triangle');
        });
    });
